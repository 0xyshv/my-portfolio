export const descriptionPoints = [
  "Won in the Arweave hackathon.",
  "Alpha Marketplace is an innovative platform developed by AlphaDevs during the OpenAI Hackathon.",
  "Leveraging Arweave Blockchain and AI classifiers, it allows users to tag, upload, and license images.",
  "With React.js frontend and an Express backend, it seamlessly connects wallets and facilitates easy asset queries.",
  "Ensuring creator recognition and monetization.",
];
